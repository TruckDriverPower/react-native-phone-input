...
import { StyleSheet, Text, TouchableOpacity, View, Modal, Picker, Dimensions } from "react-native";
        ...
        <View style={styles.basicContainer}>
          <View style={[styles.modalContainer, { backgroundColor: this.props.pickerBackgroundColor || "white" }]}>
            ...
            <View style={styles.mainBox}>
              <Picker ref={"picker"} style={styles.bottomPicker} selectedValue={this.state.selectedCountry} onValueChange={country => this.onValueChange(country)} itemStyle={itemStyle} mode="dialog">
